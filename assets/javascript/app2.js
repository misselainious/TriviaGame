$(document).ready(function () {
    ...
    // shuffle(arr);
        ...
        $("#answer1Button").text(questions.question[count].correctAnswer);
        $("#answer4Button").text(questions.question[count].incorrect1); 
        $("#answer2Button").text(questions.question[count].incorrect2);
        $("#answer3Button").text(questions.question[count].incorrect2);
